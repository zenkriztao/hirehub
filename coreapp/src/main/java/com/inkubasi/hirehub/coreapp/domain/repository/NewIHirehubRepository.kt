package com.inkubasi.hirehub.coreapp.domain.repository
...
interface NewIHirehubRepository {
    ...
    fun editProfileCompany(
        ...
        webUrl: String,
        industry: String,
                           employee: String, description: String) : Flow<Resource<EditCompanyResponse>>
