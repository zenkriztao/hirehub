...
import com.inkubasi.hirehub.databinding.ActivityRegisterCompanyBinding
import org.koin.androidx.viewmodel.ext.android.viewModel

class RegisterCompanyActivity : AppCompatActivity() {
    private lateinit var binding: ActivityRegisterCompanyBinding
    private val registerCompanyViewModel: RegisterCompanyViewModel by viewModel()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        registerCompanyViewModel.state.observe(this) {
            if (it.isLoading) {
            ...
            if (policyChecked) {
                ...
                if (username.isNotEmpty() && password.isNotEmpty()) {
                    if (password.length <= 8) {
                        ...
                        registerCompanyViewModel.registerCompany(username, password)
                    }
                }
            } else Toast.makeText(this, getString(R.string.policy_description), Toast.LENGTH_SHORT)
                .show()
        }
